        ...
        <div>
            ...
            <div className="container mx-auto px-4 py-16 lg:px-16">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <CostCard title="Median home price" value="$850,000" />
                    <CostCard
            ...
            <CallToActionSection
                ...
                benefits={[
                    ...
                    {
                        text: 'Understand school zoning and neighborhoods',
                        icon: (
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-7 w-7"
                    ...
                    {
                        text: 'Identify off-market opportunities',
                        icon: (
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-7 w-7"
                    ...
                    {
                        text: 'Negotiate effectively in a high-demand market',
                        icon: (
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-7 w-7"
            ...
            <FinalInfoSection
                property={{
                    ...
                    description:
                        'Franklin may be the perfect fit if you’re looking for:',
                    points: [
                        'Top-tier schools',
                        'Luxury and upscale living',
