...
export default function Disclaimer() {
  return (
        <div className="bg-primary py-16 px-6 text-center text-background border-t border-primary mt-20">
        <div className="max-w-4xl mx-auto">
            <h4 className="text-4xl font-bold mb-6 tracking-wider">Disclaimer</h4>
