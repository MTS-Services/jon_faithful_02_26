...
const TrustSection: React.FC = () => {
  return (
    <section className="relative py-12 bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('assets/images/home/A-person_-man-looking-at-the-setting-sun_-Blue-Ridge-Mountains_-Grindstone-Mountain_-Powel-Mountain_-The-Point-Overlook_-Shenandoah-National-scaled.jpeg')" }}>
