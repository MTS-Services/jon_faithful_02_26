      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <a href="why-tennessee" className="inline-flex items-center bg-primary text-white px-8 py-5 rounded-full hover:bg-secondary transition text-md font-medium">
              Learn More About Us 
