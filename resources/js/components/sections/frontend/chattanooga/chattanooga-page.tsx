        ...
        <div>
            ...
            <div className="container mx-auto px-4 py-16 lg:px-16">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <CostCard title="Medium home price" value="$325,000" />
                    <CostCard
            ...
            <FinalInfoSection
                property={{
                    ...
                    footer: 'For many relocating buyers, Chattanooga offers one of the best lifestyle-to-cost ratios in Tennessee.',
                    cities: [
                        {
                            name: 'Knoxville',
                            route: route('frontend.livingInKnoxville'),
                        },
                        {
                            name: 'Nashville',
                            route: route('frontend.livingInNashville'),
                        },
                        {
                            name: 'Johnson City',
                            route: route('frontend.livingInJohnsonCity'),
                        },
                        {
                            name: 'Franklin',
                            route: route('frontend.livingInFranklin'),
                        },
                    ],
                }}
            />
