export default function Hero() {
    return (
        <div>
            <div className="relative flex h-[300px] w-full items-center justify-center overflow-hidden sm:h-[400px] md:h-[500px]">
                <img
                ...
                <div className="relative z-10 container mx-auto px-4 sm:px-6">
                    <div className="max-w-3xl text-background">
                        <h2 className="mb-4 font-montserrat text-2xl font-medium text-background sm:mb-5 sm:text-3xl md:mb-6 md:text-4xl lg:text-5xl">
                            Cost of Living in Tennessee
                        </h2>

                        <p className="mb-4 font-montserrat text-base leading-relaxed font-extrabold text-background sm:mb-5 sm:text-base md:mb-6">
