              ...
              <div className="flex flex-wrap gap-[10px] mb-[22px]">
                {resolvedCityPresets.map((preset) => (
                  <button
                    ...
                    className="border border-[#dce7f2] bg-white text-[#163047] px-[14px] py-[10px] rounded-full text-[0.92rem] font-extrabold cursor-pointer hover:bg-[#f7fbff] hover:border-[rgba(29,95,149,0.30)] transition-colors duration-150"
                  >
                    {preset.label}
                  </button>
                ))}
