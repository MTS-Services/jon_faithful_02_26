...
export default function LiveTennessee() {
  return (
    <FrontendLayout>
        ...
        <div className="bg-primary-background py-28 flex items-center justify-center p-8 font-sans">
          <div className="container mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <div className="pt-4">
                <a href={route('frontend.livingInNashville')} className="inline-block bg-chart-2 text-white px-8 py-3 rounded-full font-medium  transition-colors shadow-lg">
      ...
      <section className="bg-background py-28 flex items-center justify-center px-4 font-sans">
          ...
          <div className="order-1 flex justify-center lg:justify-start">
            <div className="relative p-2 rounded-sm">
              <img
                ...
                alt="Nashville Skyline at Sunset"
                className="w-full h-[350px] md:h-[500px] object-cover rounded-sm shadow-md"
              />
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-chart-2 text-white rounded-lg p-8 flex flex-col items-center text-center shadow-lg">
              ...
              <a href={route('frontend.livingInKingsport')} className="bg-white text-black font-medium py-3 px-6 rounded-full hover:bg-gray-100 transition duration-300 w-full md:w-auto">
            ...
            <div className="bg-chart-2 text-white rounded-lg p-8 flex flex-col items-center text-center shadow-lg">
              ...
              <a href={route('frontend.livingInBristol')} className="bg-white text-black font-medium py-3 px-6 rounded-full hover:bg-gray-100 transition duration-300 w-full md:w-auto">
            ...
            <div className="bg-chart-2 text-white rounded-lg p-8 flex flex-col items-center text-center shadow-lg">
              ...
              <a href={route('frontend.livingInJackson')} className="bg-white text-black font-medium py-3 px-6 rounded-full hover:bg-gray-100 transition duration-300 w-full md:w-auto">
      ...
      <section className="relative py-24 bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('https://whytennessee.com/wp-content/uploads/2026/01/Memphis-scaled.jpeg')" }}>
        ...
        <div className="relative z-10 mx-auto text-white text-center flex flex-col items-center justify-center">
          ...
          <p className="text-sm md:text-base mb-8 leading-relaxed font-light max-w-xl">
