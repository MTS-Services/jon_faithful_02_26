...
const statRows = [
  { category: 'State Income Tax', illinois: '4.95% (flat)', tennessee: '0%' },
  { category: 'Avg Property Tax Rate', illinois: '~2.08% (VERY high)', tennessee: '0.49%' },
  { category: 'Avg Monthly Cost of Living', illinois: '~$5,400', tennessee: '~$4,800' },
  { category: 'Median Home Price', illinois: '~$280K', tennessee: '~$317K' },
  { category: 'Avg Rent (2-bed)', illinois: '~$1,800', tennessee: '~$1,400' },
  { category: 'Population Trend', illinois: 'Declining', tennessee: 'Growing Fast' },
];
...
const bestPlaces = [
  {
    ...
    IconBox: Building2,
    bullets: ['Closest big-city feel to Chicago', 'Strong job market', 'Higher cost'],
  },
  {
    id: 'knoxville',
    title: 'Knoxville',
    ...
    IconBox: Mountain,
    bullets: ['Affordable and growing fast', 'Close to Smoky Mountains'],
  },
  {
    id: 'chattanooga',
    title: 'Chattanooga',
    ...
    IconBox: Leaf,
    bullets: ['Outdoor lifestyle + tech growth', 'One of the fastest-growing cities'],
  },
  {
    id: 'tri-cities',
    ...
    IconBox: Home,
    bullets: ['Very affordable housing', 'Strong for investors', 'Growing relocation demand'],
  },
];

const movingCostRows = [
  { type: 'DIY Truck', cost: '$1,000 – $3,000', alt: false },
  { type: 'Moving Company', cost: '$3,000 – $7,500', alt: true },
  { type: 'Full-Service', cost: '$5,000 – $10,000', alt: false },
];

const whyLeavingData = {
  title: 'Why People Are Moving from Illinois to Tennessee',
  description: 'Top reasons:',
  points: [
    'High property taxes (biggest driver)',
  ...
  return (
    <FrontendLayout activePage="moving-to-tennessee" subPage="Moving from Illinois to Tennessee">
      ...
      <Hero
        ...
        description={
          <>
            <p className="mb-2">Thinking about moving from Illinois to Tennessee? You’re not alone.</p>
            <p className="mb-2">
              Illinois is one of the top outbound states in the U.S., with thousands of residents leaving each year for
              places like Tennessee due to high taxes, rising cost of living, and better housing affordability.
            </p>
            <p>
              This guide breaks down real stats, cost comparisons, taxes, housing trends, and lifestyle differences so
              you can decide if Tennessee is the right move.
            </p>
          </>
        }
        width="max-w-3xl"
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-16 text-center">
            <h2 className="inline-flex items-center gap-3 text-3xl font-semibold tracking-tight text-white md:text-4xl">
              ...
              Illinois vs Tennessee: Key Stats Comparison
            </h2>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-700/50 bg-slate-800/40 backdrop-blur-sm">
            <div className="grid grid-cols-3 border-b border-slate-700/50 bg-slate-800/80 p-5">
              ...
              <div className="text-sm font-medium uppercase tracking-wide text-slate-400">Illinois</div>
            ...
            <div className="divide-y divide-slate-700/50">
              {statRows.map((row) => (
                ...
                >
                  ...
                  <div className="text-base text-slate-300">{row.illinois}</div>
          ...
          <div className="mx-auto mt-12 max-w-3xl rounded-xl border border-indigo-500/20 bg-indigo-500/10 p-6 text-center">
            ...
            <p className="text-lg leading-relaxed tracking-tight text-slate-200">
              Tennessee = no income tax + MUCH lower property taxes
            </p>
            <p className="text-lg leading-relaxed tracking-tight text-slate-200">
              Illinois = one of the highest-tax states in the U.S.
            </p>
            <p className="text-lg leading-relaxed tracking-tight text-slate-200">
              Overall = Tennessee is significantly cheaper long-term
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8 shadow-sm lg:p-10">
              ...
              <p className="mb-8 text-base tracking-tight text-slate-600">
                One of the biggest reasons people are moving to Tennessee from Illinois is affordability.
              </p>
              <div className="space-y-4">
                <div className="mb-2 text-sm font-medium uppercase tracking-wide text-slate-500">Real Cost Differences:</div>
                <ul className="space-y-3">
                  {[
                    <>Tennessee is about <strong>10–15% cheaper</strong> overall</>,
                    'Housing is cheaper long-term due to taxes',
                    'Utilities are similar',
                    'Transportation is often cheaper in Tennessee',
                  ].map((line, i) => (
              ...
              <div className="mt-8 rounded-xl border border-amber-100 bg-amber-50 p-5">
                ...
                <ul className="mb-4 space-y-2 text-sm tracking-tight text-amber-800">
                  <li className="flex items-center justify-between border-b border-amber-200/60 pb-2">
                    <span>Illinois average:</span> <span className="font-medium">~$5,400</span>
                  </li>
                  <li className="flex items-center justify-between border-b border-amber-200/60 pb-2">
                ...
                <p className="flex items-center gap-2 text-base font-medium tracking-tight text-amber-900">
                  ...
                  That’s $6,000–$8,000/year savings
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div className="order-2 lg:order-1">
              ...
              <p className="mb-8 text-lg tracking-tight text-slate-600">
                At first glance, Illinois homes may look cheaper — but taxes change everything.
              </p>
              <div className="mb-8 grid gap-6 sm:grid-cols-2">
                <div className="rounded-xl border border-indigo-100 bg-indigo-50 p-5">
                  ...
                  <ul className="space-y-2">
                    {[
                      'Lower property taxes (HUGE savings)',
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
                  <h4 className="mb-3 text-base font-semibold tracking-tight text-primary">Illinois Challenges</h4>
                  <ul className="space-y-2">
                    {[
                      'Extremely high property taxes (~2.08%)',
                      'Older housing stock in many areas',
                      'Slower appreciation in some regions',
                    ].map((txt) => (
              ...
              <div className="mb-8 rounded-2xl border-2 border-indigo-400/40 bg-gradient-to-br from-indigo-950 to-slate-900 p-6 shadow-lg md:p-8">
                <h4 className="mb-4 flex items-center gap-2 text-lg font-semibold tracking-tight text-white">
                  <Lightbulb className="h-6 w-6 shrink-0 text-amber-400" aria-hidden />
                  Real Example (This is the game changer)
                </h4>
                <p className="mb-4 text-sm font-medium text-slate-300">On a $300,000 home:</p>
                <ul className="mb-4 space-y-3 text-sm tracking-tight text-slate-200">
                  <li className="flex flex-wrap items-baseline justify-between gap-2 border-b border-slate-700/80 pb-3">
                    <span>Illinois property tax:</span>
                    <span className="font-semibold text-amber-300">~$6,200/year</span>
                  </li>
                  <li className="flex flex-wrap items-baseline justify-between gap-2 pb-1">
                    <span>Tennessee property tax:</span>
                    <span className="font-semibold text-emerald-400">~$1,500/year</span>
                  </li>
                </ul>
                <p className="mb-2 text-base font-medium text-white">That’s $4,700/year savings</p>
                <p className="text-sm text-slate-400">Over 10 years = $47,000+ saved</p>
              </div>

              <div className="mb-8 rounded-xl border border-slate-200 bg-slate-50 p-5">
                <h4 className="mb-3 text-sm font-semibold tracking-tight text-primary">Home Price Comparison</h4>
                <ul className="space-y-2 text-sm tracking-tight text-slate-600">
                  <li className="flex justify-between gap-2">
                    <span>Chicago suburbs:</span> <span className="font-medium">~$300K–$400K</span>
                  </li>
                  <li className="flex justify-between gap-2">
                    <span>Nashville:</span> <span className="font-medium">~$430K</span>
                  </li>
                  <li className="flex justify-between gap-2">
                    <span>East Tennessee:</span> <span className="font-medium">$250K–$350K</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-8 rounded-xl bg-primary p-6 shadow-md">
                ...
                <div className="space-y-6">
                  <div>
                    <h5 className="mb-2 text-sm font-semibold tracking-tight text-slate-300">No State Income Tax in Tennessee</h5>
                    <ul className="mb-2 space-y-1 text-sm tracking-tight text-slate-400">
                      <li className="flex justify-between">
                        <span>Illinois:</span> <span>4.95%</span>
                      </li>
                      <li className="flex justify-between">
                    ...
                    <p className="rounded-lg border border-emerald-500/20 bg-emerald-500/10 px-3 py-1.5 text-xs font-medium tracking-tight text-emerald-400">
                      On $100,000 income: Illinois tax ≈ $4,950 | Tennessee tax = $0
                    </p>
                  </div>
                  <div>
                    <h5 className="mb-2 text-sm font-semibold tracking-tight text-slate-300">Massive Property Tax Difference</h5>
                    <ul className="mb-2 space-y-1 text-sm tracking-tight text-slate-400">
                      <li className="flex justify-between">
                        <span>Illinois:</span> <span>~2.08% (one of the highest in the U.S.)</span>
                      </li>
                      <li className="flex justify-between">
                        <span>Tennessee:</span> <span>~0.49%</span>
                      </li>
                    </ul>
                    <p className="rounded-lg border border-amber-500/20 bg-amber-500/10 px-3 py-1.5 text-xs font-medium tracking-tight text-amber-300">
                      This is the #1 reason people leave Illinois
                    </p>
                  </div>
                  <p className="text-sm tracking-tight text-slate-300">
                    Overall tax burden: Tennessee ranks among the lowest-tax states, while Illinois ranks among the
                    highest.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-xl border border-amber-100 bg-amber-50 p-5">
                ...
                <div className="tracking-tight">
                  <p className="mb-1 text-sm font-semibold text-amber-900">Investor insight (important)</p>
                  <p className="text-sm text-amber-800">
                    Tennessee offers better cash flow, lower holding costs, and stronger ROI potential.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-16 text-center">
            <h2 className="inline-flex flex-wrap items-center justify-center gap-3 text-3xl font-semibold tracking-tight text-primary md:text-4xl">
              <Building2 className="h-10 w-10 shrink-0 text-slate-500" aria-hidden />
              <span className="text-slate-400">vs</span>
              <Mountain className="h-10 w-10 shrink-0 text-secondary" aria-hidden />
              <span>Lifestyle: Illinois vs Tennessee</span>
            </h2>
          </div>
          <div className="mb-12 grid gap-8 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  'Less congestion than Chicago',
                  'Mountains, lakes, outdoor lifestyle',
                  'Warmer winters',
                ].map((txt) => (
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <ul className="space-y-4">
                {[
                  'Big-city infrastructure (Chicago level)',
          ...
          <div className="mx-auto max-w-2xl rounded-xl bg-primary p-6 text-center shadow-md">
            <span className="mb-3 block text-sm font-medium uppercase tracking-wide text-slate-400">Lifestyle shift</span>
            <p className="mb-2 text-base tracking-tight text-slate-200">
              <strong>Illinois</strong> = urban, fast-paced
            </p>
            <p className="text-base tracking-tight text-slate-200">
              <strong>Tennessee</strong> = more relaxed, scenic, community-focused
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-3xl font-bold text-white mb-2">Best Places in Tennessee for Illinois Transplants</h2>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mb-10 grid gap-8 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8">
              <h4 className="mb-4 text-lg font-semibold tracking-tight text-primary">Illinois Strengths:</h4>
              <ul className="space-y-3">
                {['Finance (Chicago)', 'Corporate HQs', 'Healthcare'].map((txt) => (
      ...
      <section className="border-b border-slate-200 bg-slate-50 py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="mb-2 inline-flex items-center gap-3 text-3xl font-semibold tracking-tight text-primary">
            ...
            Cost to Move from Illinois to Tennessee
          </h2>
          ...
          <p className="text-sm font-medium tracking-tight text-slate-700">Mid-range distance = moderate cost</p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-16 text-center">
            <h2 className="inline-flex items-center gap-3 text-3xl font-semibold tracking-tight text-white md:text-4xl">
              ...
              Pros &amp; Cons of Moving from Illinois to Tennessee
            </h2>
          </div>
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-700/50 bg-slate-800/40 p-8 lg:p-10">
              ...
              <ul className="space-y-5">
                {['Smaller metro areas', 'Less public transportation', 'Fewer large corporate hubs'].map((txt) => (
                  <li key={txt} className="flex items-start gap-4 text-base tracking-tight text-slate-300">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-24">
            <div>
              ...
              <p className="mb-6 text-lg font-medium tracking-tight text-primary">For most people — absolutely yes.</p>
              <div className="mb-8">
      ...
      <section className="border-b border-slate-200 bg-slate-50 py-24 text-center">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <p className="mb-8 text-lg tracking-tight text-slate-600">
            Moving from Illinois to Tennessee is one of the biggest financial upgrades you can make.
          </p>
          ...
          <div className="mb-10 inline-block rounded-r-xl border border-l-0 border-slate-100 border-t border-r border-b bg-white py-4 pl-4 pr-8 text-left text-sm tracking-tight text-slate-600 shadow-sm">
            <div className="space-y-3 border-l-2 border-indigo-500 pl-4">
              {[
                ...
                'Pay drastically less in property taxes',
