    ...
    return (
        <UserDashboardLayout>
         <div className="flex items-center space-x-4 p-2">
                ...
                <div className="flex">
                <button className="flex-1 bg-secondary text-white py-3 px-4 flex items-center justify-left space-x-2 font-medium text-sm hover:bg-[#b89644] transition-colors">
                    <span>Edit Post</span>
                ...
                <button className="flex-1 bg-primary text-white py-3 px-4 flex items-center justify-left space-x-2 font-medium text-sm hover:bg-[#1a2e52] transition-colors">
                ...
                <div className="relative h-64">
                <img
                    src="https://whytennessee.com/wp-content/uploads/2025/12/images-14.png"
                    alt="Historic Bungalow"
                    className="w-full h-full object-cover"
                />
                ...
                <div className="relative h-64">
                <img
                    src="https://whytennessee.com/wp-content/uploads/2025/12/ce_180814_02.jpg"
                    alt="Historic Bungalow"
                    className="w-full h-full object-cover"
                />
