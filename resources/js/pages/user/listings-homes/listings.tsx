                    ...
                    <div className="max-w-sm bg-white rounded-lg shadow-xl overflow-hidden  ">
                        ...
                        <div className="p-2 h-34">
                            ...
                            <div className="grid grid-cols-2 gap-y-5 text-gray-800">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="font-medium truncate">{`${listing.city?.name}, TN`}</span>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="font-medium ">Bedroom: {listing.bedrooms}</span>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="font-medium">Bathroom: {listing.bathrooms}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex">
                            <div className='w-full'>
                                <Link href={route('user.edit-listing-home', listing.id)}>
