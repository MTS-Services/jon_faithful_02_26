                ...
                {data.map((rental: any) => (
                    <div className="w-full max-w-86 flex-shrink-0 bg-white rounded-2xl shadow-xl overflow-hidden">
                        ...
                        <div className="p-2">
                            ...
                            <div className="grid grid-cols-2 gap-y-5 text-gray-800">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="font-medium truncate">{`${rental.city?.name}, TN`}</span>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="font-medium ">Bedroom: {rental.bedrooms}</span>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="font-medium">Bathroom: {rental.bathrooms}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex">
                            ...
                            <div className='w-full'>
                                <ActionButton IconNode={Trash} href={route('user.delete-listing-home', rental.id)} className="rounded-none w-full!">
                                    Delete Post
                                </ActionButton>
                            </div>
                        </div>
