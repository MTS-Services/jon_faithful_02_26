...
class FrontendController extends Controller
{
     ...
     public function movingFromCalifornia(): Response
     {
          return Inertia::render('frontend/moving-from-california');
     }

     public function movingFromNewYorkCity(): Response
     {
          return Inertia::render('frontend/moving-from-new-york-city');
     }

     public function movingFromFlorida(): Response
     {
          return Inertia::render('frontend/moving-from-florida');
     }

     public function movingFromTexas(): Response
     {
          return Inertia::render('frontend/moving-from-texas');
     }

     public function movingFromArizona(): Response
     {
          return Inertia::render('frontend/moving-from-arizona');
     }
     public function movingFromNorthCarolina(): Response
     {
          return Inertia::render('frontend/moving-from-north-carolina');
     }

     public function movingFromVirginia(): Response
     {
     ...
     public function isTennesseeCheaperThanTexas(): Response
     {
          return Inertia::render('frontend/is-tennessee-cheaper-than-texas');
     }

     public function isTennesseeCheaperThanFlorida(): Response
     {
          return Inertia::render('frontend/is-tennessee-cheaper-than-florida');
     }
